...
router.get('/', authenticateToken, roleMiddleware(['user', 'admin', 'superAdmin']), listDevices);
router.get('/:id', authenticateToken, roleMiddleware(['user', 'admin', 'superAdmin']), getDeviceById);
