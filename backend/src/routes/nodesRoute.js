...
router.get('/map', authenticateToken, roleMiddleware(['user', 'admin', 'superAdmin']), listNodesForMap);
router.get('/by-gateway/:gatewayDeviceId', authenticateToken, roleMiddleware(['user', 'admin', 'superAdmin']), listNodesByGateway);
